...
def get_schema(key, seo):
    ...
    if key == "index":
        ...
        # Category page gets CollectionPage + BreadcrumbList schema
...
def main():
    ...
    for key, seo in seo_config.items():
        ...
        content = re.sub(r'app\.js(?:\?v=[\d\.]+)?', 'app.js?v=1.1.20', content)
        ...
        print(f"Generated {file_name} with custom SEO, schemas, and version v=1.1.20")
